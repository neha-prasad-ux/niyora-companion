...
/// The HealthKit spike UI. Not the real product — a diagnostic surface to
/// confirm, on a physical iPhone, that we can authorize and read real HRV
...
struct ContentView: View {
    ...
    var body: some View {
        NavigationStack {
            ...
            .navigationTitle("Niyora · HRV Spike")
        }
    }
